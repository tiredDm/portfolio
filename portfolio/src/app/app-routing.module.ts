...
const routes: Routes = [
  ...
  {path:'Map/drogheda/redrock',     component: DroghedaRedrockComponent, data: {order : '4'} },
  {path:'Map/drogheda/dozehaven',   component: DroghedaDozehavenComponent, data: {order : '4'}},
  {path:'Map/drogheda/rimouth',     component: DroghedaRimouthComponent, data: {order : '4'}},
  {path:'Map/drogheda/forktown',    component: DroghedaForktownComponent, data: {order : '4'}},
  {path:'Map/drogheda/riveride',    component: DroghedaRiverideComponent, data: {order : '4'}},
  {path:'Map/drogheda/orchidring',  component: DroghedaOrchidringComponent, data: {order : '4'}},
  {path:'Map/drogheda/forreson',    component: DroghedaForresonComponent, data: {order : '4'}},
  {path:'Map/drogheda/hopeton',     component: DroghedaHopetonComponent, data: {order : '4'}},
