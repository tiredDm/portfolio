...
@Component({
  ...
  `,
  styles: [
    '.lbar{width:100vw ;height: 8vh; position: fixed ; left: 0px; bottom: 0px; margin: 0px; padding: 0px; display: flex; flex-direction: row; border: 2px; background-color: #3b3832; z-index: 9; border-top: 3.5px solid #191a16 }', 
