...
@Component({
  ...
  `,
  styles: [
    '.card {color: white; border: 7px solid grey; box-sizing: border-box; border-radius: 25px; aspect-ratio: 5/6; width: 12vw; display: flex; flex-direction:column; justify-content:center; text-align:center; background-color: #3b3832; transition: all .2s ease;}',
