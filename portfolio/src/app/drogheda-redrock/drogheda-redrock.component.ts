...
@Component({
  selector: 'app-drogheda-redrock',
  template: `<p>drogheda-redrock works!</p>
  <div class = "page-layout">
    <div class = "map-card">
      <div class = "map-layout">
        <img class = "map" src= "assets/img/maps/Redrock-map.png">
...
export class DroghedaRedrockComponent {}
