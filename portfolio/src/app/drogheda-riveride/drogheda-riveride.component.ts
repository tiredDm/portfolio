...
@Component({
  selector: 'app-drogheda-riveride',
  template: `<p>drogheda-riveride works!</p>
  <div class = "page-layout">
    <div class = "map-card">
      <div class = "map-layout">
        <img class = "map" src= "assets/img/maps/Riveride-map.png">
      </div>
    </div> 
  </div>
...
export class DroghedaRiverideComponent {}
